...
being built into the app. EverythingBox ships with a catalog addon covering all eight kinds of
media: films, shows, games, music, audiobooks, books, comics and manga.
